...
const csvFilter = (req, file, cb) => {
    if (file.mimetype.includes("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") || file.mimetype.includes("application/vnd.ms-excel") || file.mimetype.includes("text/csv")) {
      cb(null, true);
    } else {
